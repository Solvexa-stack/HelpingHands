...
|---|---|---|---|---|---|
| 0 — Foundations | [11_WAVE_0_FOUNDATIONS.md](11_WAVE_0_FOUNDATIONS.md) | 🔵 | 2026-07-07 | | **W0-E1 complete** (163 e2e tests; CI gate — ⚠️ admin still to mark `e2e-regression-suite` required). **W0-E2**: S1 event bus ✅ · S2 ActorContext ✅ · S3 emission projects/study/voting ✅ (12 event types live, full-lifecycle sequence spec; 183 e2e + 42 unit green). 11 bugs in [backlog/BACKLOG_BUGS.md](backlog/BACKLOG_BUGS.md). Next: W0-E2-S4 emission donations/payments/execution |
